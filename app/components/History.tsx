                        ...
                        <div className="flex flex-col justify-start">
                            ...
                            {value.links.map((link: {name: string, url: string, status: number}) => {
                                switch (link.status) {
                                    case 1:
                                        return (
                                            <div className="flex flex-row gap-3 ms-10 me-6">
                                    ...
                                    default:
                                        return (
                                            <a href={link.url} target="_blank" rel="noopener noreferrer" className="text-m font-light ms-10 me-6 p-1 max-w-min hover:text-sky-500 text-overflow">{link.name}</a>
                                        )
                                }
                            })}
